...
export default function AppDevelopment() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Mobile App Development | iOS & Android Apps | Poeage Technology
        </title>
        <meta
          name="description"
          content="Expert mobile app development for iOS and Android. We create user-friendly, scalable, and high-performance mobile applications for your business."
        />
        <meta
          name="keywords"
          content="app development, mobile app development, iOS development, Android development, cross-platform apps"
        />
        <link rel="canonical" href="https://www.poeagetechnology.com/appde" />

        <meta
          property="og:title"
          content="Mobile App Development | iOS & Android Apps"
        />
        <meta
          property="og:description"
          content="Expert mobile app development services for iOS and Android platforms."
        />
        <meta
          property="og:url"
          content="https://www.poeagetechnology.com/appde"
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="iOS, Android, and cross-platform app development solutions."
        />
      ...
      >
        ...
        <p className="text-sm sm:text-base md:text-lg max-w-3xl mx-auto">
          Explore our 5 unique application development services including iOS,
          Android, Cross-Platform, Enterprise, and App Support.
        </p>
        <button
