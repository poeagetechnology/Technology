          ...
          {[
            {
              ...
              qualification:
                "B.E/B.Tech in CSE/IT or equivalent with 1+ years experience.",
              description:
                "Build scalable applications, write clean code, and collaborate with cross-functional teams.",
            ...
            },
            {
              ...
              role: "AI Developer",
              qualification:
                "Experience in Machine Learning, Deep Learning, and Python frameworks.",
              description:
                "Design and deploy AI-driven solutions for real-world business problems.",
              email: "mailto:hr@poeage.com",
            },
            {
              id: 3,
              role: "Data Analyst",
              qualification:
                "Bachelor’s/Master’s in Statistics, Data Science, or related field.",
              description:
                "Analyze business data, generate insights, and support decision-making.",
