...
export default function HomeServicesUnique() {
  ...
  // SEO Metadata
  const pageTitle =
    "Web Development, App Development & AI Solutions | Poeage Technology";
  const pageDescription =
    "Poeage Technology delivers world-class web development, mobile app development, AI solutions, cloud services, and digital transformation for enterprises. Get innovative tech solutions today.";
  const canonicalUrl = getCanonicalUrl("/");

  const breadcrumbData = [{ label: "Home", path: "/" }];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="web development, app development, AI solutions, cloud services, software development company, digital transformation, enterprise solutions"
        />
        ...
        <meta
          property="og:image"
          content="https://www.poeagetechnology.com/Poeage_Logo_6.png"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify(generateBreadcrumbSchema(breadcrumbData))}
        </script>
      </Helmet>
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-md">
              Poeage Technology crafts intelligent digital solutions that
              empower businesses to innovate and thrive globally.
            </p>
            <motion.button
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            We deliver world-class software solutions crafted with innovation,
