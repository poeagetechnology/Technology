  ...
  const services = [
    {
      ...
      title: "AI Chatbots",
      description:
        "Intelligent conversational systems that automate support, sales, and onboarding.",
    ...
    },
    {
      ...
      description:
        "Predictive analytics, recommendation engines, and smart decision systems.",
    ...
    },
    {
      ...
      title: "Automation",
      description:
        "Workflow automation that reduces manual work and improves efficiency.",
    ...
    },
    {
      ...
      title: "Data Insights",
      description:
        "Dashboards and analytics that turn raw data into actionable insights.",
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6">
              Build smart, automated, and scalable solutions powered by modern
              AI & ML technology.
            </p>
