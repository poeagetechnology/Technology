      ...
      <main className="min-h-screen bg-slate-50 px-6 py-20">
        ...
        <section className="max-w-7xl mx-auto text-center mb-20">
          ...
          <p className="mt-6 text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Centralized access to documentation, support services, and training
            resources designed to help organizations maximize the value of
            Poeage Technology platforms.
          </p>
