      ...
      items: [
        {
          ...
          desc: "Cutting-edge AI and ML solutions for smart automation and predictive insights.",
        },
        {
          icon: <FaCloudSun />,
          title: "Cloud-Native Platforms",
          desc: "Highly scalable and secure cloud applications and infrastructure.",
        },
        {
          icon: <FaShieldAlt />,
          title: "Cybersecurity & Compliance",
          desc: "Advanced security solutions ensuring protection and compliance.",
        },
        {
          icon: <FaMicrochip />,
          title: "IoT & Smart Devices",
          desc: "Connected device solutions enabling real-time monitoring and control.",
        },
        {
          icon: <FaWrench />,
          title: "Rapid Low-Code Development",
          desc: "Quickly deploy enterprise-grade apps with minimal coding.",
        },
      ],
    },
  ];
      ...
      items: [
        {
          ...
          desc: "Tools like Office 365, Teams for productivity and teamwork.",
        },
        {
          icon: <FaGlobe />,
          title: "Web Navigation Tools",
          desc: "Browsers and internet tools optimized for speed and security.",
        },
        {
          icon: <FaRobot />,
          title: "Development & Analytics",
          desc: "IDE, DB management and analytics tools for software creation.",
        },
        {
          icon: <FaRocket />,
          title: "Creative & Media",
          desc: "High-performance media software for design, video, and music production.",
        },
      ],
    },
  ];
      ...
      <div className="bg-gradient-to-b from-gray-50 via-white to-gray-50 min-h-screen">
        ...
        >
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto">
            Explore innovative, secure, and scalable software solutions designed
          ...
          {tools.map((section, idx) => (
            ...
            >
              {section.items.map((tool, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center text-center p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-transform transform hover:-translate-y-1 hover:scale-105"
                >
        ...
        >
          ...
          <p className="max-w-2xl mx-auto mb-6">
            Partner with us to create intelligent, scalable, and interactive
            software and tools for the modern business landscape.
          </p>
          <button
            onClick={() => navigate("/quotes")}
