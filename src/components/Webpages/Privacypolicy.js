    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="max-w-3xl md:max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-8 md:py-10">
          <div className="bg-white shadow-md rounded-xl p-6 md:p-8">
            ...
            <p className="mb-4 md:mb-6 text-gray-700 text-sm md:text-base">
              Poeage Technology Private Limited ("we", "our", "us") values your
              privacy and is committed to protecting your personal information.
              This Privacy Policy explains how we collect, use, and safeguard
              your data when you use our website and applications.
            </p>
            ...
            <p className="mb-4 md:mb-6 text-gray-700 text-sm md:text-base">
              ...
              us at <strong>info@poeage.com</strong>.
            </p>
            ...
            <p className="mb-1 font-medium text-sm md:text-base">
              Poeage Technology Private Limited
            </p>
            <p className="mb-1 text-sm md:text-base">
              36A, Main Road, Kavundhapadi, Erode
            </p>
            <p className="mb-1 text-sm md:text-base">
        ...
        <footer className="bg-white py-6 md:py-8 text-center text-sm md:text-base text-gray-500 border-t">
          <p>
            © {new Date().getFullYear()} Poeage Technology Private Limited. All
            rights reserved.
          </p>
        </footer>
      </div>
