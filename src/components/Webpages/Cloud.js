...
export default function WebServices() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <motion.div
        className="text-center py-24 px-6 lg:px-20 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-b-3xl shadow-lg"
      ...
      >
        ...
        <p className="text-lg md:text-xl max-w-3xl mx-auto">
          Cutting-edge web solutions for businesses, startups, and enterprises.
        </p>
      </motion.div>
      ...
      >
        {services.map((service, i) => (
          ...
          >
            ...
            />
            <div className="p-6">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-gradient-to-br from-indigo-100 to-indigo-200 text-3xl mb-4">
                {service.icon}
              </div>
              ...
              <button
                ...
                className="px-5 py-2 rounded-full text-sm font-semibold text-white bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-purple-500 hover:to-indigo-500 shadow-md transition"
              >
                Get a Quote
              </button>
            </div>
